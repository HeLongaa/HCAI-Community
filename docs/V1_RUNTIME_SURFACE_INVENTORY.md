...
| `frontend-chat-workspace-simulation` | Chat replies remain local; the backend now provides encrypted durable conversations, governed selected context, and application-classified Mock SSE | Production Chat UI and real Provider adapter | V1-23, V1-24, V1-39 |
...
| `server-provider-fixture-injection` | OpenAI Image and Replicate product dispatch plus manual replay clients remain fixture-injected; Chat uses a deterministic Mock stream and application safety classifier | Retain tests and keep real product dispatch unregistered | V1-05 through V1-08, V1-12, V1-14, V1-16, V1-21, V1-22 |
