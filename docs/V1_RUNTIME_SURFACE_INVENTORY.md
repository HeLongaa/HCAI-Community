...
| `frontend-chat-workspace-simulation` | Chat replies remain local; V1-21 now provides encrypted durable conversations and a Mock-only SSE API | Production Chat UI and real Provider adapter | V1-22 through V1-24, V1-39 |
...
| `server-provider-fixture-injection` | OpenAI Image and Replicate product dispatch plus manual replay clients remain fixture-injected; V1-21 adds only a classified Mock Chat stream adapter | Retain tests and keep real product dispatch unregistered | V1-05 through V1-08, V1-12, V1-14, V1-16, V1-21 |
