...
| `frontend-music-workspace-simulation` | Music controls and queue are simulated; the server now exposes a fail-closed V1 capability contract, but this UI does not consume it yet | Real Music application workflow or explicit unavailable state | V1-30 through V1-34, V1-39 |
