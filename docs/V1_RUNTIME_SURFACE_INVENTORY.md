...
| `server-music-capability-contract` | The Music contract freezes instrumental and lyrics-to-song modes, closed parameters, three-minute MP3 output, rights/license/data gates, lifecycle and budgets while ElevenLabs and Lyria remain disabled catalog shells | Retain the fail-closed contract; keep adapters, HTTP, credentials, lifecycle, output ingestion, real calls, voice/TTS adjacency, and production enablement unavailable | V1-30 through V1-34, V1-39 |
