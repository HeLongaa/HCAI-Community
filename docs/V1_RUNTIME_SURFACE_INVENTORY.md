...
| `server-music-capability-contract` | The Music contract freezes instrumental and lyrics-to-song modes, closed parameters, three-minute MP3 output, rights/license/data gates, lifecycle and budgets; ElevenLabs has an injected fixture-only request/response boundary with strict MP3, license and generated-minute cost projection, while both Provider catalog shells remain disabled | Retain the fail-closed contract and fixture adapter; keep product registration, HTTP, credentials, lifecycle, output ingestion, real calls, voice/TTS adjacency, and production enablement unavailable | V1-30 through V1-34, V1-39 |
