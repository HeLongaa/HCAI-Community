...
| `server-video-capability-contract` | The Video model, mode, input, output, lifecycle, composition, safety, persistence, and budget contract is executable while Veo and Runway remain disabled catalog shells | Retain the contract and keep Video adapters, clients, lifecycle registration, and production enablement disabled until V1-26 through V1-29 close | V1-25 through V1-29, V1-39 |
