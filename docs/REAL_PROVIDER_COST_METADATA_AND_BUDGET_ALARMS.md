...
- Add budget threshold and anomaly alert event generation. Fixture-only pure event planning exists; future work still needs repository persistence, notification routing, and metrics exporter wiring per `docs/REAL_PROVIDER_BUDGET_EVENT_WIRING_PLAN.md`.
