...
- Inspiration discovery uses the `inspiration` group; sanitized client telemetry uses the `observability` group without treating ingestion as an Admin authorization grant.
