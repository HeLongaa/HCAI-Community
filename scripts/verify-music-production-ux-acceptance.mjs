...
const staging = read('server/src/creative/routerMusicStagingAcceptance.test.js')
const checks = []
...
check('quality profile is frozen', contract.quality.profile === 'mp3_44100_256' && contract.quality.sampleRateHz === 44100 && contract.quality.bitrateKbps === 256)
check('capability publishes the quality profile', capability.includes("qualityProfile: 'mp3_44100_256'") && capability.includes('sampleRateHz: 44100') && capability.includes('bitrateKbps: 256'))
...
check('E2E proves quality and rights presentation', e2e.includes("toHaveValue('mp3_44100_256')") && e2e.includes('not requesting artist imitation'))
