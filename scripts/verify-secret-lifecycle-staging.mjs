...
add('Vault Agent reloads certificate identity and writes a file sink', ['method "cert"', 'enable_reauth_on_new_credentials = true', 'reload        = true', 'path = "/run/vault-agent/token"'].every((needle) => agentConfig.includes(needle)), 'Vault Agent')
