...
add('SLOs and multi-window burn rates are implemented', contract.slos.every((slo) => runtime.includes(`'${slo.id}'`)) && runtime.includes('shortWindowBurn >= 14.4') && runtime.includes('longWindowBurn >= 6'), 'availability/latency burn')
