...
test('GET /api/creative/providers lists safe provider capability metadata', async () => {
  ...
  try {
    ...
    assert.equal(chatCapability.runtime.attachmentBytesImplemented, false)
    assert.equal(chatCapability.runtime.productionSafetyClassifierImplemented, false)
    ...
    assert.equal(terra.safeMetadata.streamingImplemented, false)
