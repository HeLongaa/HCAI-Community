...
const structuredSettingOverrides = (setting) => {
  ...
  if (setting.key === 'ai.video') return {
    CREATIVE_ROUTER_VIDEO_PROVIDER_TYPE: value.provider ?? 'hcai-router',
    CREATIVE_ROUTER_VIDEO_HTTP_CLIENT_ENABLED: value.enabled,
    CREATIVE_ROUTER_VIDEO_NETWORK_CALLS_ENABLED: value.enabled,
    CREATIVE_ROUTER_VIDEO_LIFECYCLE_ENABLED: value.enabled,
    CREATIVE_ROUTER_VIDEO_CONFIRMATION: value.enabled ? 'staging-only' : '',
    CREATIVE_ROUTER_VIDEO_BASE_URL: value.baseUrl,
    CREATIVE_ROUTER_VIDEO_MODEL: value.model,
    CREATIVE_ROUTER_VIDEO_API_KEY: value.apiKeyRef,
    CREATIVE_ROUTER_VIDEO_PROVIDER_ACCOUNT_REF: value.providerAccountRef,
    CREATIVE_ROUTER_VIDEO_DAILY_BUDGET_USD: value.dailyBudgetUsd,
    CREATIVE_ROUTER_VIDEO_BUDGET_THRESHOLD_PERCENT: value.budgetThresholdPercent,
  }
  if (setting.key === 'ai.music') return {
    CREATIVE_ROUTER_MUSIC_PROVIDER_TYPE: value.provider ?? 'hcai-router',
    CREATIVE_ROUTER_MUSIC_HTTP_CLIENT_ENABLED: value.enabled,
    CREATIVE_ROUTER_MUSIC_NETWORK_CALLS_ENABLED: value.enabled,
    CREATIVE_ROUTER_MUSIC_CONFIRMATION: value.enabled ? 'staging-only' : '',
    CREATIVE_ROUTER_MUSIC_BASE_URL: value.baseUrl,
    CREATIVE_ROUTER_MUSIC_MODEL: value.model,
    CREATIVE_ROUTER_MUSIC_API_KEY: value.apiKeyRef,
    CREATIVE_ROUTER_MUSIC_PROVIDER_ACCOUNT_REF: value.providerAccountRef,
    CREATIVE_ROUTER_MUSIC_STAGING_RIGHTS_ACKNOWLEDGED: value.stagingRightsAcknowledged,
    CREATIVE_ROUTER_MUSIC_TRAINING_OPT_OUT_CONFIRMED: value.trainingOptOutConfirmed,
    CREATIVE_ROUTER_MUSIC_LICENSE_ID: value.licenseId,
    CREATIVE_ROUTER_MUSIC_TERMS_VERSION: value.termsVersion,
  }
