...
export const permissionRegistry = Object.freeze([
  ...
  definePermission('admin:auth:read', 'identity-access', 'oauth_operation', 'read', 'high', moderators, { description: 'Read secret-free OAuth provider, account, and authorization operations' }),
  definePermission('admin:auth:manage', 'identity-access', 'oauth_operation', 'manage', 'critical', admins, { protected: true, protectionRank: 3, resourceAuthorization: true, description: 'Control OAuth providers and safely revoke OAuth access' }),
