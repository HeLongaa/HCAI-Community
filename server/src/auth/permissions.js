...
export const permissionRegistry = Object.freeze([
  ...
  definePermission('admin:notifications:read', 'notifications-webhooks', 'notification_template', 'read', 'high', moderators, { description: 'Read notification templates, versions, preference metrics, and exports' }),
  definePermission('admin:notifications:manage', 'notifications-webhooks', 'notification_template', 'manage', 'critical', admins, { protected: true, protectionRank: 30, resourceAuthorization: true, description: 'Create, edit, archive, and restore notification template drafts' }),
