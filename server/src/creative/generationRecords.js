...
const safeProviderJobIdPattern = /^(?:[a-z0-9][a-z0-9:_-]{0,96}|projects\/[a-z][a-z0-9-]{4,62}\/locations\/us-central1\/publishers\/google\/models\/[a-z0-9][a-z0-9._-]{2,96}\/operations\/[a-zA-Z0-9._-]{8,160})$/i
...
export const buildCreativeGenerationRecordPayload = (generation, actor, overrides = {}) => ({
  ...
  modelVersionId: overrides.modelVersionId ?? generation.modelVersionId ?? null,
  modelDeploymentId: overrides.modelDeploymentId ?? generation.modelDeploymentId ?? null,
  pricingVersionId: overrides.pricingVersionId ?? generation.pricingVersionId ?? null,
