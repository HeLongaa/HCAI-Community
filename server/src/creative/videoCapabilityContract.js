...
export const videoCapabilityContract = {
  ...
  runtime: {
    ...
    governedInputResolverImplemented: true,
    inputBytesReaderImplemented: true,
    lifecycleProjectionImplemented: true,
    providerOperationPersistenceImplemented: true,
    providerHttpClientImplemented: false,
    providerLifecycleRegistered: true,
    providerLifecycleEnabled: false,
    fixtureStatusReaderOnly: true,
