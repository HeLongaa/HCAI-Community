...
export const musicCapabilityContract = {
  ...
  asOf: '2026-07-13',
  workspace: 'music',
  decisionState: 'router_minimax_staging_guarded_upstream_plan_blocked',
  runtime: {
    ...
    fixtureAdapterOnly: false,
    providerHttpClientImplemented: true,
    providerCredentialsImplemented: true,
    providerResponseValidationImplemented: true,
    licenseMetadataProjectionImplemented: true,
    providerCostMetadataImplemented: true,
    applicationLifecyclePersistenceImplemented: true,
  ...
  models: {
    primary: {
      ...
      modelId: 'music-3.0',
      apiFamily: 'router_minimax_music_generation',
      decisionState: 'staging_adapter_ready_upstream_plan_blocked',
      registered: false,
      enabled: false,
      fixtureAdapterImplemented: true,
      modes: ['instrumental', 'lyrics_to_song'],
      routerAndUpstreamTermsRequired: true,
  ...
  cost: {
    ...
    providerUnits: ['request'],
    providerSpendSeparatedFromProductCredits: true,
    primaryPublicBaselineUsdPerRequest: 0.15,
  ...
  rights: {
    enterpriseResellerAndMediaRightsRequired: false,
    routerAndUpstreamTermsRequired: true,
