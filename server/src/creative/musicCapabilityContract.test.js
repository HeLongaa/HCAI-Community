...
test('Music capability freezes rights, lifecycle, output, budget, and Provider boundaries', () => {
  ...
  assert.equal(musicCapabilityContract.runtime.providerAdapterRegistered, false)
  assert.equal(musicCapabilityContract.runtime.fixtureAdapterOnly, true)
  assert.equal(musicCapabilityContract.runtime.providerHttpClientImplemented, false)
  assert.equal(musicCapabilityContract.runtime.providerCredentialsImplemented, false)
